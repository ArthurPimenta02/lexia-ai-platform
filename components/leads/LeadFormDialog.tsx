...
export function LeadFormDialog({
  ...
  const selectClass = cn(
    'h-8 w-full rounded-lg border border-input bg-background px-2.5 py-1 text-sm text-foreground',
    'outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50',
    'disabled:opacity-50 dark:bg-card dark:text-foreground dark:[color-scheme:dark] transition-colors'
  )
